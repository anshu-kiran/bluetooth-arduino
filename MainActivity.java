package com.example.anshu.bluetooth;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void offNotification() {
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this)
                        ...
                        .setContentText("OFF!!").setSmallIcon(R.mipmap.ic_launcher).setAutoCancel(true);
    ...
    private void onNotification() {
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this)
                        .setContentTitle("NOTIFICATION")
                        .setContentText("ON!!").setSmallIcon(R.mipmap.ic_launcher).setAutoCancel(true);
